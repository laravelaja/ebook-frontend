...
export const MainLayout = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center py-0 sm:py-8 bg-sky-50 relative overflow-hidden select-none">
      ...
      <div 
        className={`w-full h-screen sm:h-[calc(100vh-64px)] glass-effect sm:rounded-lg overflow-hidden flex flex-col relative sm:border sm:border-slate-200 z-10 transition-all duration-300 ${
